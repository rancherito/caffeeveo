      ...
      @if (videos().length > 0) {
        <div class="video-list">
          ...
          @for (video of videos(); track video.id) {
            <div class="video-item" [class.active]="isCurrentVideo(video.id)" [class.processing]="video.isProcessing">
              <div class="video-info">
                ...
                @if (video.isProcessing) {
                  <div class="processing-bar">
                    <div class="processing-fill" [style.width.%]="video.processingProgress"></div>
                  </div>
                }
              </div>
              <div class="video-actions">
                ...
                <button (click)="removeVideo(video.id)" class="btn-remove">
                  ✕
                </button>
              </div>
            </div>
